...
export default function ContactForm() {
  return (
    <section id="contact" className="py-40 bg-neutral-50 dark:bg-neutral-950 relative overflow-hidden flex flex-col items-center">
      ...
      <div className="max-w-4xl w-full mx-auto px-6 relative z-10">
        <div className="text-center mb-16">
          ...
          <h3 className="text-5xl md:text-7xl font-serif text-black/90 dark:text-white/90">Begin your journey</h3>
        </div>

        <form className="grid grid-cols-1 md:grid-cols-2 gap-8 text-black/80 dark:text-white/80" onSubmit={(e) => e.preventDefault()}>
          ...
          <div className="md:col-span-2 flex justify-center mt-12">
            <button className="relative group px-16 py-6 overflow-hidden rounded-sm border border-neutral-300 dark:border-neutral-700 bg-white dark:bg-black hover:border-amber-500 transition-all duration-500">
