...
export default function Introduction() {
  ...
  return (
    <section ref={containerRef} className="relative py-32 md:py-48 px-6 w-full bg-white dark:bg-black flex flex-col items-center justify-center min-h-[80vh] overflow-hidden">
      ...
      />
      <div className="absolute inset-0 bg-gradient-to-t from-neutral-50 dark:from-neutral-950 via-transparent to-neutral-50 dark:to-neutral-950 z-0 pointer-events-none" />

      {/* Content */}
      <div className="relative z-10 max-w-7xl mx-auto flex flex-col items-center">
        <h2 className="text-4xl md:text-6xl lg:text-7xl text-center text-black/90 dark:text-white/90 font-serif leading-tight drop-shadow-lg">
