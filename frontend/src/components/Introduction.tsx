...
export default function Introduction() {
  ...
  return (
    <section ref={containerRef} className="relative py-32 md:py-48 px-6 w-full bg-black flex flex-col items-center justify-center min-h-[80vh] overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto flex flex-col items-center">
        <h2 className="text-4xl md:text-6xl lg:text-7xl text-center text-white/90 font-serif leading-tight drop-shadow-lg">
          Welcome to the <span className="italic text-amber-500">extraordinary</span> life.
        </h2>
        <p ref={textRef} className="mt-12 text-xl md:text-3xl text-center text-neutral-300 font-sans max-w-4xl mx-auto leading-relaxed text-balance drop-shadow-md">
